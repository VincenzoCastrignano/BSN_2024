# Instructions étape par étape pour l'inscription d'un User

* Refaire la class User avec les données les plus importantes.
* Apprendre à récupérer les valeurs dans les "box" du front et les rappeler en console.
* Mettre en fonction le fait de récupérer les valeurs.
* Faire une fonction qui envoie en json (local) les données de façon structuré.
* Gérer l'action d'ajouter les données sur le json.
* Faire l'envoie sur la page suivante
